...
function testCPU(matrixA, matrixB) {
  console.log('TESTIN CPU', matrixA, matrixB)
}

function matrixMultCPU(matrixA, matrixB) {
  ...
  console.log('cpu matrixA', matrixA)
  console.log('cpu matrixB', matrixB)
